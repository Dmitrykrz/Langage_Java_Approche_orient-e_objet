...
public class Round extends Figure implements Surfacable {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || (!getClass().isAssignableFrom(o.getClass()) && !o.getClass().isAssignableFrom(getClass())))
            return false;
        Round r = ((Round) o);
        return r.centre.equals(this.centre) && r.radius == this.radius && r.figure_color==this.figure_color;
    }
    ...
    public Round(Point centre, int radius) {
               this(centre,radius,Couleur.getCouleurDefaut());
    }


    public Round(Point centre, int radius,Couleur c) {
        this.centre = centre;
        this.radius = radius;
        this.figure_color=c;
    }
    ...
    public String toString() {
        return "ROND[" + centre.toString() + "," + radius +    ";" +this.figure_color.getShortColorCode() +"]";
    }
