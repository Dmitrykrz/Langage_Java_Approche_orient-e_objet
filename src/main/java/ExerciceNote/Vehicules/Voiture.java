...
public class Voiture extends Routier implements AMoteur {
    ...
    private static final int essenceReservoirDefault = 50;

    public Voiture(String marque, String modele, String numImmat) {
        this(marque, modele, numImmat,essenceReservoirDefault);
    }

    public Voiture(String marque, String modele, String numImmat, double essenceReservoirSet) {
    ...
    public String toString() {
        return "Voiture N° : " + numImmat + ", Modéle : " + marque + " " + modele;
    }
}