...
public class Bateau extends Maritime  implements AMoteur {
    ...
    private static final int essenceReservoirDefault = 200;

    public Bateau(String marque, String modele, String numImmat) {
        this(marque, modele, numImmat,essenceReservoirDefault);
    }

    public Bateau(String marque, String modele, String numImmat, double essenceReservoirSet) {
    ...
    public String toString() {
        return "Bateau N° : " + numImmat + ", Modéle : " + marque + " " + modele;
    }
}